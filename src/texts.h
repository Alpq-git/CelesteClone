...
void init_strings()
{
    ...
    Strings[(int)LOCALIZATION_GER * STRING_COUNT + (int)STRING_CELESTE_CLONE] = "Celeste Clone";
    Strings[(int)LOCALIZATION_GER * STRING_COUNT + (int)STRING_MADE_IN_CPP] = "Geschrieben in C++";

    Strings[(int)LOCALIZATION_TUR * STRING_COUNT + (int)STRING_CELESTE_CLONE] = "Celeste Kopyasi";
    Strings[(int)LOCALIZATION_TUR * STRING_COUNT + (int)STRING_MADE_IN_CPP] = "C++'da yapildi";
}
