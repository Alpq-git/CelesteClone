...
//                  OpenGL Constants
//#################################################
const char* TEXTURE_PATH = "assests/textures/TEXTURE_ATLAS.png";
...
bool gl_init(BumpAllocator* transientStorage)
{
    ...
    // Validate if programs works
    {
        int programSuccess;
        char programInfoLog[512];
        glGetProgramiv(glContext.programID, 512, 0, programInfoLog);
    ...
    // This has to be done, otherwise OpenGL not draw anything
    GLuint VAO;
